             ...
             <div class="card">
                 ...
                 <div class="card-body">
                     <button type="button" class="btn btn-success float-right" data-toggle="modal" data-target="#tambah_data">
                        <i class="fas fa-plus"></i>  Transaksi Barang Masuk
                     </button>
                 </div>
                 <div class="card-body">
                     ...
                     <form method="POST" action="">
                         ...
                         <div class="form-group row">
                             ...
                             <div class="col-sm-8">
                                 ...
                                 <input name="tgl" id="tanggal" class="form-control datepicker" placeholder="Tanggal Masuk" type="text" required autocomplete="off">
